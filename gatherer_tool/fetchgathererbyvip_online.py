...
#	print "<tr><td><a href=\"getchecks.php?ip="+element[0]+"\">"+element[0]+"</a></td>"
	if(g_check_flag==0):
		...
		print "<tr><td><a href=\"getchecks.php?ip="+element[0]+"\">"+element[0]+"</a></td><td>Online &nbsp;&nbsp; <img src=\"./cssjs/greentick.png\" style=\"width:20px; height:20px\" title=\"Online\"></td>"
        elif(g_check_flag==2):
	    if(state=='online'):
                continue
            else:
                print "<tr><td><a href=\"getchecks.php?ip="+element[0]+"\">"+element[0]+"</a></td><td>Offline  &nbsp;&nbsp; <img src=\"./cssjs/redtick.png\" style=\"width:20px; height:20px\" title=\"Offline\"></td>"
        else:
	    if(state=='online'):
                continue
            else:
                print "<tr><td><a href=\"getchecks.php?ip="+element[0]+"\">"+element[0]+"</a></td><td>Sensu Check not running  &nbsp;&nbsp; <img src=\"./cssjs/redtick.png\" style=\"width:20px; height:20px\" title=\"Offline\"></td>"
	...
	if(critical_check_flag==1):
                ...
                print "<td>Critical Checks <img src=\"./cssjs/redtick.png\" style=\"width:20px; height:20px\" title=\"Critical Checks\">:<br>{2}<a href=\"getchecks.php?ip={0}\"><br>More info</a></td>".format(element[0],c_count,check_names)
        else:
                print "<td>No Critical Alerts on Sensu  &nbsp;&nbsp; <img src=\"./cssjs/greentick.png\" style=\"width:20px; height:20px\" title=\"No Alerts on Sensu\"></td>"
	print "<td>{0}</td></tr>".format(gatherer_thread_count)
    except KeyError:
	print "<tr><td><a href=\"getchecks.php?ip={0}\">"+element[0]+"</a></td><td>Sensu Check not running  &nbsp;&nbsp; <img src=\"./cssjs/redtick.png\" style=\"width:20px; height:20px\" title=\"Sensu Check not running\"></td><td bgcolor=\"#ff471a\">Unable to get details</td><td>Unable to get details</td><td>Unable to get details</td></tr>"
